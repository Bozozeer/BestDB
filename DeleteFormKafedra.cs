...
namespace BestDB
{
    public partial class DeleteFormKafedra : Form
    {
        ...
        private void DisplayRecord(int index)
        {
            if (dataTable.Rows.Count > 0)
            {
                ...
                textBox1.Text = dataTable.Rows[index]["short_name"].ToString();
                textBox2.Text = dataTable.Rows[index]["name_kafedra"].ToString();
        ...
        public static void DeleteRecord(int id)
        {
            ...
            {
                string query = "DELETE FROM kafedra WHERE id = @id";
